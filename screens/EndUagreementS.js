...
class EndUserAgreement extends Component{
  ...
  render(){
    ...
    <SafeAreaView style={{ flex : 1 }}>
     <View style={styles.container}>
            <Text style={styles.title}> Wathaeq Terms and conditions</Text>
            <ScrollView 
            ...
            >
                <Text style={styles.tcP}>Welcome to our Application. If you continue to browse and use this Application, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern [business name]’s relationship with you in relation to this Application. If you disagree with any part of these terms and conditions, please do not use our Application.</Text>
                <Text style={styles.tcP}>The term ‘Wathaeq’ or ‘us’ or ‘we’ refers to the owner of the Application whose registered office is ------. Our company registration number is **** Dubai, UAE. The term ‘you’ refers to the user or viewer of our Application.</Text>
                    ...
                    <Text style={styles.tcL}>{'\u2022'} This Application uses cookies to monitor browsing preferences. If you do allow cookies to be used, the following personal information may be stored by us for use by third parties: [insert list of information].</Text>
...
Unauthorised use of this Application may give rise to a claim for damages and/or be a criminal offence.</Text>
                    ...
                    <Text style={styles.tcL}>{'\u2022'} Your use of this Application and any dispute arising out of such use of the Application is subject to the laws of England, Northern Ireland, Scotland and Wales.</Text>
